        ...
        <div className="container">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <div className="flex flex-col lg:flex-row">
                  ...
                  <p className="dark:text-body-color-dark text-body-color mb-9 text-base leading-relaxed">
                    Desenvolvemos soluções digitais personalizadas para pequenos
                    e médios negócios, ajudando-os a crescer e se destacar
                    online.
                  </p>
                </div>
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="dark:text-body-color-dark text-body-color hover:text-primary dark:hover:text-primary mr-6 duration-300"
                  >
                    <svg
                      width="9"
                      height="18"
                  ...
                  <a
                    ...
                    aria-label="social-link"
                    className="dark:text-body-color-dark text-body-color hover:text-primary dark:hover:text-primary duration-300"
                  >
                    <svg
                      width="17"
                      height="16"
          ...
          <div className="py-8">
            <p className="text-body-color text-center text-base dark:text-white">
              © 2025 KiSite, todos direitos reservados.{" "}
            </p>
          </div>
        </div>
