...
export default function HeroHomeContainer() {
  return (
    <div>
      ...
      >
        <div className="flex w-full flex-col items-center justify-center gap-10 p-2 align-middle lg:flex-row lg:justify-around lg:p-14 lg:pb-4">
          <div className="bg-successGreen flex h-64 w-4/5 flex-col items-center justify-center rounded-3xl bg-softLavender p-4 text-center lg:w-1/3">
